...
import { Leaf, Cloud, TrendingUp, Bug, Droplets, Video, User, UserPlus, LogIn } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
      ...
      <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 text-sm">
        <strong>Debug Info:</strong> useAuth loaded - isAuthenticated: {isAuthenticated ? 'true' : 'false'}, 
        user: {user ? user.name || 'Unknown' : 'null'}
      </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link 
                  to="/login"
                  className="group bg-white text-gray-700 px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 border-2 border-gray-200 hover:border-green-300 flex items-center"
                >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">856</div>
              <div className="text-sm text-gray-600">Farms Monitored</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">12,400</div>
              <div className="text-sm text-gray-600">AI Predictions</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">94.2%</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <Link
                  to={feature.route}
                  className="w-full bg-gradient-to-r from-green-500 to-blue-600 text-white py-3 px-4 rounded-lg font-semibold text-center block hover:shadow-lg transform hover:scale-105 transition-all duration-200"
                >
